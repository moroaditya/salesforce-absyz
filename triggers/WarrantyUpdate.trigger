...
******************************************************************************/
trigger  WarrantyUpdate on Entitlement (after Insert,after Update) {
    ...
    if(trigger.isUpdate && trigger.isAfter){
        List<Entitlement> entitleList = [select Name,Product_Name__c,Warranty_Years__c,Order_Product__c,Contacts__c,Order__c,Certified_Installer__c from  Entitlement where id IN:trigger.new];
